...
namespace Epwing2Anki
{
  ...
  public class Mecab
  {
    //   This method often caused this exception:
    //     System.AccessViolationException: Attempted to read or write protected memory. This is often an indication that other memory is corrupt.
    //     at Epwing2Anki.Mecab.mecab_sparse_tostr(IntPtr m, Byte[] str)
    //       at Epwing2Anki.Mecab.parse(String input, Boolean userDic) in E:\Dev\CSharp\Epwing2Anki\Epwing2Anki\Mecab.cs:line 188
    //   at Epwing2Anki.Mecab.parseFields(String input, Boolean userDic) in E:\Dev\CSharp\Epwing2Anki\Epwing2Anki\Mecab.cs:line 226
    //     at Epwing2Anki.UtilsRuby.addAnkiRubyToText(String text) in E:\Dev\CSharp\Epwing2Anki\Epwing2Anki\UtilsRuby.cs:line 45
    //
    ...
    //    {
    //      string mecabUserDicLoc = String.Format("{0}Mecab{1}mecab_user_dic.dic", 
    //        ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
    //      string mecabDicLoc = String.Format("{0}Mecab{1}dic{1}ipadic",
    //        ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
    //      string mecabRcFile = String.Format("{0}Mecab{1}etc{1}mecabrc", 
    //        ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
    ...
    {
      string parsedText = "";
      string mecabLoc = String.Format("{0}Mecab{1}bin{1}mecab.exe", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabUserDicLoc = String.Format("{0}Mecab{1}mecab_user_dic.dic", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabInputFile = String.Format("{0}Mecab{1}mecab_in.txt", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabOutputFile = String.Format("{0}Mecab{1}mecab_out.txt", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabDicLoc = String.Format("{0}Mecab{1}dic{1}ipadic", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabRcFile = String.Format("{0}Mecab{1}etc{1}mecabrc", ConstantSettings.UtilsDir, Path.DirectorySeparatorChar);
      string mecabUserDicArg = "";
    ...
    public static List<InfoMecab> parseFields(string input, bool userDic)
    {
      ...
      string result = Mecab.parseWithExe(input, userDic);
      ...
      if ((mecabList.Count > 0) && mecabList[mecabList.Count - 1].Word == "EOS")
      {
